...
public class App {
    ...
    private static ArvoreBusca<Aluno> alunos = new ArvoreBusca<>();
    private static ArvoreBusca<Disciplina> disciplinas = new ArvoreBusca<>();
    private static ArvoreBusca<Turma> turmas = new ArvoreBusca<>();
    ...
    static void listarAlunosMatriculados() {
        ...
        if (disciplina == null) {
            ...
            if (turma == null) {
                ...
                System.out.println("NumMat  Nome do Aluno               Nota1  Nota2");
                System.out.println("------  --------------------------  -----  -----");
                ...
                while (aluno != null) {
                    ...
                    MyIterator<Notas> nIt = aluno.getNotas().iterator();
                    Notas nota = nIt.getFirst();
                ...
                for (int i = 0; i < vetorAlunos.length; i++) {
                    ...
                    if (alunoOrd.getNotas().isEmpty()) {
                        nota1 = 0.0f;
                        nota2 = 0.0f;
                    } else {
                        nota1 = alunoOrd.getNotas().iterator().getFirst().getNota1();
                        nota2 = alunoOrd.getNotas().iterator().getFirst().getNota2();
                    }

                    System.out.printf("%6d  %-26s   %2.2f   %3.2f\n", alunoOrd.getNumMat(),
                            alunoOrd.getNmAluno(), nota1, nota2);
                }
            }
        }
            ...
            if (aluno == null) {
                ...
                if (disciplina == null) {
                    ...
                    if (turma == null) {
                        ...
                        if (aluno.getTurmas().retrieve(turma) == null) {
                            System.err.println("Este aluno não está matriculado nesta turma");
                        } else {
                            float nota1 = Keyboard.readFloat("Informe a nota1: ");
                            float nota2 = Keyboard.readFloat("Informe a nota2: ");

                            Notas notas = new Notas(numMat, codDisc, codTurma, nota1, nota2);
                            aluno.getNotas().add(notas);
                        }
                    }
                }
            }
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            opcao = Keyboard.menu("Incluir Aluno/Listar Alunos/Excluir Alunos"
                    ...
                    + "Matricular Aluno/Listar alunos matriculados/"
                    + "Incluir Notas/Terminar");
