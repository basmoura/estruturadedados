...
public class DemoArvoreBinaria {
	...
	static void preOrdem(NoArvoreBin raiz) {		
		if (raiz != null) {
			System.out.println(raiz.getObj().toString());
	...
	static void simetrica(NoArvoreBin raiz) {		
		if (raiz != null) {
			simetrica(raiz.getEsq());
			System.out.println(raiz.getObj().toString());			
			simetrica(raiz.getDir());
		}
	}
	
	static void posOrdem(NoArvoreBin raiz) {		
		if (raiz != null) {
	...
	static void emNivel (NoArvoreBin raiz){
		...
		fila.insira(raiz);
		while (!fila.isEmpty()) {
			NoArvoreBin no = (NoArvoreBin) fila.remova();
			System.out.println(no.getObj().toString());
			if(no.getEsq() != null){
	...
	public static void main(String[] args) {
		...
		/*
		 * desenhe(50); 
		 * System.out.println("Remover a raiz"); 
		 * delete(raiz);
		 * desenhe(50);
		 */
