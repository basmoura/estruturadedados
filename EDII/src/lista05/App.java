...
public class App {
	...
	private static ArvoreAVL<Aluno> alunos = new ArvoreAVL<Aluno>();
	private static ArvoreAVL<Disciplina> disciplinas = new ArvoreAVL<Disciplina>();
	private static ArvoreAVL<Turma> turmas = new ArvoreAVL<Turma>();
