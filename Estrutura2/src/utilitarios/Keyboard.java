...
public class Keyboard{
	...
	public static long readLong(String texto) {
		...
		do {
			...
			try {
				ok = true;
				valor = new Scanner(System.in).nextLong();
			} catch (Exception exception) {
				System.out.println("Valor invalido");
				ok = false;
			}
	...
	public static byte readByte(String texto) {
		...
		do {
			...
			try {
				ok = true;
				valor = new Scanner(System.in).nextByte();
			} catch (Exception exception) {
				System.out.println("Valor invalido");
				ok = false;
			}
	...
	public static char readChar(String texto) {
		...
		do {
			...
			try {
				ok = true;
				valor = new Scanner(System.in).next().charAt(0);
			} catch (Exception exception) {
				System.out.println("Valor invalido");
				ok = false;
			}
	...
	public static int readShort(String texto) {
		...
		do {
			...
			try {
				ok = true;
				valor = new Scanner(System.in).nextShort();
			} catch (Exception exception) {
				System.out.println("Valor invalido");
				ok = false;
			}
