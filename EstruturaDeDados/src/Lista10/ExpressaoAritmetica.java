...
public final class ExpressaoAritmetica {

    protected static boolean erro;
    protected static int inic;

    public static double calcule(String expInfixa) {
        if (expInfixa.length() > 0) {
    ...
    private static double calcule(char operador, double opnd1, double opnd2) {
        switch (operador) {
            case '+':
                return opnd1 + opnd2;
            case '-':
