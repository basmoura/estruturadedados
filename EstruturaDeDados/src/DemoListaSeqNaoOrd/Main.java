...
public class Main {
    ...
    static ListaSeqNaoOrd<Pessoa> pessoas = new ListaSeqNaoOrd(10);
    static ObjectFile arqPessoas = new ObjectFile("teste.dat");
    ...
    static void CadastrarPessoa() {
        ...
        do {
            ...
            if (pessoas.contains(new Pessoa(codPessoa))) {
                ...
                pessoas.add(new Pessoa(codPessoa, nome, dataNasc));
            }
